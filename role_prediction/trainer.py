...
def encode_labels(df):
    ...
    Path(LABEL_ENCODER).parent.mkdir(
        parents=True,
        exist_ok=True,
    )
...
def main():
    ...
    model, cv_accuracy, best_params = train_model(
        X_train,
        y_train,
    )
    ...
    print("\n" + "=" * 60)
    print("CareerPilot AI Role Prediction Training Completed!")
    print("=" * 60)
